          ...
          <ScrollAnimation animateIn='fadeIn'>
             ...
             <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={7}>
                    <CommonHeaderSection label="ABOUT ME" headingBig="Hello I'm Shariq Ansari" headingSmall="Programmer with hands-on practice of
designing and developing websites. Efficient in
React Framework, enthusiastic in building,
maintaining Projects, and improving User
Experience." withIcon={false} isAlign={false} arrowLogo={<ArrowDownwardRoundedIcon/>}/>
                    <br />
                    <Grid container>
